...
class Node {
    ...
    static SIZE = 70;                    // Diameter of the nodes
    ...
    static EDGETHICKNESS = 10;            // Thickness this node's upper edge
    ...
    static VERTICALSPACING = 90;   // Vertical distance between tow nodes
